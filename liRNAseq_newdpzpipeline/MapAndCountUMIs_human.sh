...
tophat -p 4 --library-type fr-firststrand --read-mismatches 5 --read-gap-length 5 --read-edit-dist 5 --no-coverage-search --segment-length 15 --transcriptome-index /groups/immdiv-bioinfo/evergrande/yael/genomes/hg19/transcriptome -o ./thoutfs /groups/immdiv-bioinfo/evergrande/yael/genomes/hg19/genome $prefix.fq
