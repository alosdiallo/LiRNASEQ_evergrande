...
# usage: /groups/cbdm_lab/dp133/scripts/umi_scripts/lecseq2_newdpzpip.sh  [dir_where_fastq.bz2_files_are - eg TRA002920 - serves also as prefix for prefix_ls_N]
...
echo "Trimming barcode (R1:6-13), UMI (1-5) and R1 (1:30)..."
#mkdir lecseq2
cd lecseq2
fastx_trimmer -Q 33 -f 6 -l 13 -i ../*R2.fastq -o bc.fastq
fastx_trimmer -Q 33 -f 1 -l 5 -i ../*R2.fastq -o umi.fastq
...
/home/yj88/immdiv_bio/evergrande/yael/liRNAseq_newdpzpipeline/add_umi_to_id.pl S bcumiR1.filtered.fastq bcumiR1.filtered.bcumitoid.fq 1 8 9 5

echo "Demultiplexing..."
cat bcumiR1.filtered.bcumitoid.fq | fastx_barcode_splitter.pl --bcfile /home/yj88/immdiv_bio/evergrande/yael/liRNAseq_newdpzpipeline/lecseq_barcodes_9-24.tab --bol --mismatch 2 --prefix ${prefix}_ --suffix ".bcumiR1.fq" &> demultiplex.stat.txt_2m
...
for dir in ${prefix}_* ; do echo $dir ; bsub -q mcore -n 2 -W 2:00 -o $dir.ls2.log /home/yj88/immdiv_bio/evergrande/yael/liRNAseq_newdpzpipeline/MapAndCountUMIs.sh $dir $dir ; done
