...
echo "Demultiplexing..."
cat bcumiR1.filtered.bcumitoid.fq | fastx_barcode_splitter.pl --bcfile /groups/immdiv-bioinfo/evergrande/copy_work/yael/liRNAseq_newdpzpipeline/lecseq_barcodes.tab  --bol --mismatch 2 --prefix ${prefix}_ --suffix ".bcumiR1.fq" &> demultiplex.stat.txt_2m
...
for dir in ${prefix}_* ; do echo $dir ; bsub -q mcore -n 2 -W 2:00 -o $dir.ls.log /groups/immdiv-bioinfo/evergrande/copy_work/yael/liRNAseq_newdpzpipeline/MapAndCountUMIs.sh $dir $dir ; done
