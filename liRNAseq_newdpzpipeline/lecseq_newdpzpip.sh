...
/home/yj88/immdiv_bio/evergrande/yael/liRNAseq_newdpzpipeline/add_umi_to_id.pl S bcumiR1.filtered.fastq bcumiR1.filtered.bcumitoid.fq 1 8 9 4

echo "Demultiplexing..."
cat bcumiR1.filtered.bcumitoid.fq | fastx_barcode_splitter.pl --bcfile /home/yj88/immdiv_bio/evergrande/yael/liRNAseq_newdpzpipeline/lecseq_barcodes.tab  --bol --mismatch 2 --prefix ${prefix}_ --suffix ".bcumiR1.fq" &> demultiplex.stat.txt_2m
...
for dir in ${prefix}_* ; do echo $dir ; bsub -q mcore -n 2 -W 2:00 -o $dir.ls.log /home/yj88/immdiv_bio/evergrande/yael/liRNAseq_newdpzpipeline/MapAndCountUMIs.sh $dir $dir ; done
