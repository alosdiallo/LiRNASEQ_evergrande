...
for dir in S* ; do echo $dir ; bsub -q mcore  -n 2 -W 36:00 -R "rusage[mem=24000]" -o $dir.liRNAseq.log /groups/immdiv-bioinfo/evergrande/copy_work/yael/liRNAseq_newdpzpipeline/liRNAseq_pipeline_2_mouse.sh $dir $dir; done
