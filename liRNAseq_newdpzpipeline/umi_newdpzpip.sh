...
/groups/immdiv-bioinfo/evergrande/copy_work/yael/liRNAseq_newdpzpipeline/add_umi_to_id.pl S bcumiR1.filtered.fastq bcumiR1.filtered.bcumitoid.fq 1 8 9 9

echo "Demultiplexing..."
cat bcumiR1.filtered.bcumitoid.fq | fastx_barcode_splitter.pl --bcfile /groups/immdiv-bioinfo/evergrande/copy_work/yael/liRNAseq_newdpzpipeline/umi_barcodes_last8bp.tab --bol --mismatch 2 --prefix ${prefix}_ --suffix ".bcumiR1.fq" &> demultiplex.stat.txt_2m
...
for dir in ${prefix}_* ; do echo $dir ; bsub -q mcore -n 2 -W 2:00 -o $dir.umi.log /groups/immdiv-bioinfo/evergrande/copy_work/yael/liRNAseq_newdpzpipeline/MapAndCountUMIs.sh $dir $dir ; done
